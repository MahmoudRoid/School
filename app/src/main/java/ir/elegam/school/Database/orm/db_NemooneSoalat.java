 ...
 */
public class db_NemooneSoalat extends SugarRecord {
    String number,english_name,image_url,pdf_url;

    public db_NemooneSoalat(){}

    public db_NemooneSoalat(String number, String english_name, String image_url, String pdf_url){
        this.number=number;
