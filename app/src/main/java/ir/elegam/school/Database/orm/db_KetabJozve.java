 ...
 */
public class db_KetabJozve extends SugarRecord {
    String number,english_name,image_url,pdf_url;

    public db_KetabJozve(){}

    public db_KetabJozve(String number, String english_name, String image_url, String pdf_url){
        this.number=number;
