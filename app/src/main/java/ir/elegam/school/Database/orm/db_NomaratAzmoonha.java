 ...
 */
public class db_NomaratAzmoonha extends SugarRecord {
    String number,english_name,image_url,pdf_url;

    public db_NomaratAzmoonha(){}

    public db_NomaratAzmoonha(String number, String english_name, String image_url, String pdf_url){
        this.number=number;
